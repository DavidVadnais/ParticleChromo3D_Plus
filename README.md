...
Square Matrix Input format: The square matrix is a tab separated N by N intra-chromosomal contact matrix derived from Hi-C data, where N is the number of regions of a chromosome.
<br><br>
...
* Add workflows for testing rust build
